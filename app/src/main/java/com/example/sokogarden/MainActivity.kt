...
//        Create the intent in the two activities
...
//        Find the recylerView and progressBar by use of their IDs
        val recyclerView = findViewById<RecyclerView>(R.id.recyclerView)
        val progressBar = findViewById<ProgressBar>(R.id.progressbar)

//        Specify the API URL endpoint
        val url = "https://mutukuryan.alwaysdata.net/api/get_products"

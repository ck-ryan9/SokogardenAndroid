...
//        Find the 2 editText, a button and a TextView by use of their IDs
...
//        On click of the button signin, we need to interact with the API end point as we part the 2 data info
        signinButton.setOnClickListener {
//            Specify the API end point
            val api = "https://kbenkamotho.alwaysdata.net/api/signin"

//            Create a request that will enable you hold the data in form of a bundle/package
